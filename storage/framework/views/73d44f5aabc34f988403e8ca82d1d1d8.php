...
<body style="margin:0;padding:24px;background:#f5f1e8;font-family:Arial,sans-serif;color:#1f2937;">
    <div style="max-width:560px;margin:0 auto;background:#ffffff;border-radius:16px;padding:32px;border:1px solid #e5e7eb;">
        ...
        <h1 style="margin:0 0 16px;font-size:28px;line-height:1.2;color:#111827;">Gmail OTP Code</h1>
        <p style="margin:0 0 16px;font-size:16px;line-height:1.6;">Hello <?php echo e($fullName); ?>,</p>
        <p style="margin:0 0 24px;font-size:16px;line-height:1.6;">Use this code to <?php echo e(match ($purpose) { 'register' => 'finish creating your account', 'verify-email' => 'verify your email address', default => 'finish signing in' }); ?>. It expires in 10 minutes.</p>
        ...
        <p style="margin:0;font-size:14px;line-height:1.6;color:#4b5563;">If you did not request this code, you can ignore this email.</p>
    </div>
</body>
</html>
<?php /**PATH C:\va-tools\resources\views\emails\auth-otp-code.blade.php ENDPATH**/ ?>
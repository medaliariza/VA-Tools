@extends('layouts.app', ['title' => 'Home | VA Tools'])
    ...
    <section class="dashboard-hero">
        <div class="dashboard-hero-inner">
            ...
            <div class="dashboard-actions">
                @auth
                    <a href="{{ route('dashboard') }}" class="dashboard-primary-action">Go To My Workspace</a>
                    <a href="{{ route('tasks.index') }}" class="dashboard-secondary-action">Start Managing Work</a>
                @else
                    <a href="{{ route('register') }}" class="dashboard-primary-action">Start Using VA Tools</a>
                    <a href="{{ route('login') }}" class="dashboard-secondary-action">Sign In To Continue</a>
                @endauth
            </div>
        </div>
    </section>
